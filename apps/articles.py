...
""", unsafe_allow_html=True)
    ...
    if category == "Produce":
        ...
        st.write("")
        with col7:
            st.image("apps/images/meat/meat_taste.jpeg", caption="Spolied salmon", use_container_width=True)
        with col8:
            st.markdown("### 👅 Taste")
        ...
        st.write("")
        with col3:
            st.image("apps/images/baked_goods/baked_smell.jpg", caption="Bacterial growth on baked good", use_container_width=False, width=350)
        with col4:
            st.markdown("### 👃 Smell")
        ...
        st.write("")
        with col7:
            st.image("apps/images/baked_goods/baked_taste.jpg", caption="Bacterial growth on pie", use_container_width=False, width=350)
        with col8:
            st.markdown("### 👅 Taste")
